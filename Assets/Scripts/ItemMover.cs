...
public class ItemMover : MonoBehaviour
{
    ...
    private IEnumerator ClearElements(List<Item> matchItems)
    {
        ...
        {
            //var parent = matchItems[i].transform.parent; //gолучили родителя элемента
        //
            ////получили координаты в массиве элемента
            //var elementCoordinates = _indexProvider.GetIndex(parent.transform.localPosition);
            //_mapBuilder.Items[elementCoordinates.y, elementCoordinates.x] = null;
